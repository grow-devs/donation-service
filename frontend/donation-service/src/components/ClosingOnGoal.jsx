    ...
    >
      ...
      >
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          <CampaignIcon color="action" fontSize="large" />
          <Typography
            variant="body1"
            color= "textPrimary"
          >
      ...
      <CardContent sx={{ pt: 2, px: 2 }}>
        <Box sx={{ mb: 1 }}>
         ...
         <Box display="flex" justifyContent="space-between" alignItems="center">
          <Typography variant="body1"> {raised.toLocaleString()}원</Typography>
          <Typography variant="body1">{goal.toLocaleString()}원</Typography>
        </Box>         
