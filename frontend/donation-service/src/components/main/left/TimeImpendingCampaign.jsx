// TimeImpendingCampaign.jsx
import React, { useEffect, useState } from 'react';
import { Typography, Box, Card, Modal, Backdrop, CircularProgress } from '@mui/material';
...
export default function TimeImpendingCampaign() {
  ...
  useEffect(() => {
    const fetchPost = async () => {
      ...
      setError(false);
      try {
        const response = await api.get('/post/earliest-end-date');
        ...
        console.error('Failed to fetch post with earliest end date:', err);
        setError(true);
      } finally {
        setLoading(false);
      }
