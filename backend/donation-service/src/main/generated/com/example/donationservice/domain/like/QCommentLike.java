...
public class QCommentLike extends EntityPathBase<CommentLike> {
    ...
    private static final long serialVersionUID = -1147395699L;
    ...
    public final com.example.donationservice.domain.comment.QComment comment;
    ...
    public QCommentLike(Class<? extends CommentLike> type, PathMetadata metadata, PathInits inits) {
        ...
        this.comment = inits.isInitialized("comment") ? new com.example.donationservice.domain.comment.QComment(forProperty("comment"), inits.get("comment")) : null;
