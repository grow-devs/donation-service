...
public interface AdminService {
    ...
    // 유저가 요청한 팀 승인
    void updateTeamApprovalStatus(Long teamId, AdminDto.ApprovalStatusReq teamStatusReq);

    Page<PostDto.PostResponse> getPostList(Pageable pageable, ApprovalStatus approvalStatus);

    // 게시물 수락 및 반려
    void updatePostApprovalStatus(Long postId, AdminDto.ApprovalStatusReq postStatusReq);
}
