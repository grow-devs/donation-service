package com.example.donationservice.config.auth;

import com.example.donationservice.config.auth.jwt.JwtFilter;
...
//                        .formLogin(Customizer.withDefaults())
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:5173", "http://localhost:3000", "https://d3fg6avo9ubvz7.cloudfront.net"));
