...
//    @Scheduled(cron = "0 47 17 * * ?")  // 매일 00시 //todo 오늘에 관한 정보이다보니 언제 스케줄링을 돌릴지도 생각해야함
    @Scheduled(fixedRate = 600000)  // 테스트를 위한 5초 스케줄
    @Transactional
...
//    @Scheduled(cron = "0 47 17 * * ?")  // 매일 23시 59분 //todo 오늘에 관한 정보이다보니 언제 스케줄링을 돌릴지도 생각해야함
    @Scheduled(fixedRate = 600000)  // 테스트를 위한 5초 스케줄
    @Transactional
